...
class BuilderTableUpdateLuismaytaCoordinacionHermanos3 extends Migration
{
    public function up()
    {
        Schema::table('luismayta_coordinacion_hermanos', function($table)
        {
            ...
            $table->integer('dia_nacimiento')->nullable()->change();
        });
    }
    ...
    public function down()
    {
        Schema::table('luismayta_coordinacion_hermanos', function($table)
        {
            ...
            $table->string('grado_estudios', 191)->default('NULL')->change();
            $table->string('email', 191)->default('NULL')->change();
            $table->integer('dia_nacimiento')->nullable(false)->change();
        });
    }
}
